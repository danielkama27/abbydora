      ...
      <section className="py-24 bg-abby-cream-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {collections.map((c) => (
              <Link key={c.id} href={`/collections/${c.slug}`} className="relative aspect-[3/4] overflow-hidden block group">
                <img
                  src={c.image || "https://images.unsplash.com/photo-1445205170230-053b83016050?w=500&h=650&fit=crop"}
                  alt={c.name}
                  className="w-full h-full object-cover brightness-[0.72] group-hover:brightness-[0.6] transition-all duration-300"
                />
