            ...
            return (
              <div key={item.id} className="group">
                <div className="relative bg-stone-50 aspect-[3/4] overflow-hidden mb-3">
                  ...
                  <button onClick={() => removeItem(item.id)} className="absolute top-3 right-3 w-8 h-8 bg-white/90 flex items-center justify-center hover:bg-stone-900 hover:text-white transition-colors">
                    <X className="h-4 w-4" />
                  </button>
                </div>
